            ...
            <div class='pic_total'>
                ...
                <div class='tuwen'>
                    ...
                    <div class='page'>
                        ...
                        <?php else: ?>
                        <div><span>上一篇:</span><a href="<?php echo url('/home/index/detailbiao',array('mid'=>$top['id'])); ?>"><?php echo $top['title']; ?></a></div>
                        ...
                        <?php else: ?>
                        <div><span>下一篇:</span><a href="<?php echo url('/home/index/detailbiao',array('mid'=>$next['id'])); ?>"><?php echo $next['title']; ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/opt/web/hqy_/public/../application/home/view/index/industrydetail.html";i:1575619221;s:53:"/opt/web/hqy_/application/home/view/common/login.html";i:1575456051;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class='pic_total'>
                ...
                <div class='tuwen'>
                    ...
                    <div class='page'>
                        ...
                        <?php else: ?>
                        <div><span>上一篇:</span><a href="<?php echo url('/home/index/industrydetail',array('mid'=>$top['id'])); ?>"><?php echo $top['title']; ?></a></div>
                        ...
                        <?php else: ?>
                        <div><span>下一篇:</span><a href="<?php echo url('/home/index/industrydetail',array('mid'=>$next['id'])); ?>"><?php echo $next['title']; ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>

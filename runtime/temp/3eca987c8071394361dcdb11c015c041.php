<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/opt/web/hqy_/public/../application/v1/view/systematic/system/editblogroll.html";i:1576140377;s:52:"/opt/web/hqy_/application/v1/view/layout/dialog.html";i:1575880777;s:50:"/opt/web/hqy_/application/v1/view/common/meta.html";i:1575011765;s:52:"/opt/web/hqy_/application/v1/view/common/script.html";i:1575011765;}*/ ?>
<!DOCTYPE html>
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="desc" name="desc" value="<?php echo $data['describe']; ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="link" class="form-control form-control-sm" name="link" value="<?php echo $data['link']; ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="status" name="status" class="form-control form-control-sm">
                            ...
                            <option value="<?php echo $key; ?>" <?php if($data['status'] == $key): ?>selected='selected'<?php endif; ?>><?php echo $status_list; ?></option>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="admin_module.edit_blogroll(this)" data="<?php echo $data['id']; ?>" data-url="<?php echo url('/v1/systematic/system/editblogroll'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

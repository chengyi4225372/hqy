<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"C:\phpEnv\www\hqy_\public/../application/home\view\index\index.html";i:1575616969;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class='hui_product'>
      <div class='w'>
        ...
        <ul class='all_product'>
          ...
          <li>
            <div class="all_product-img-box"><img src="<?php echo (isset($v1['imgs']) && ($v1['imgs'] !== '')?$v1['imgs']:''); ?>" alt=""></div>

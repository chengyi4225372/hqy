<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:70:"/opt/web/hqy_/public/../application/v1/view/cate/ifications/index.html";i:1577184979;s:53:"/opt/web/hqy_/application/v1/view/layout/default.html";i:1575880812;s:50:"/opt/web/hqy_/application/v1/view/common/meta.html";i:1575011765;s:52:"/opt/web/hqy_/application/v1/view/common/header.html";i:1575426269;s:50:"/opt/web/hqy_/application/v1/view/common/left.html";i:1576659286;s:52:"/opt/web/hqy_/application/v1/view/common/footer.html";i:1575011765;s:52:"/opt/web/hqy_/application/v1/view/common/script.html";i:1575011765;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <!-- 加载样式及META信息 -->
                ...
                <div class="panel panel-default panel-btn">
                    <div class="panel-heading">
                        ...
                        <div class="form-group">
                            <label>关键字：</label>
                            <input type="text"  id="keywords" class="form-control" style="width:312px;" name="title" value="<?php echo $params['title']; ?>" placeholder="多个关键字用中英文逗号或空格隔开...">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="disable" class="selectpicker" multiple  title="全部" >
                                ...
                                <option value="<?php echo $key; ?>" <?php if(in_array($key,$params['disable'])): ?>selected='selected'<?php endif; ?>><?php echo $disable_list; ?></option>
        ...
        <div class="box-body">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $vo['disable']; ?></td>
                    <td class="text-center"><?php echo $vo['create_time']; ?></td>
                    <td class="text-center">
                        <?php if($vo['status'] == 1): ?>
                        <span class="btn btn-success" onclick="dels(this)" data-url="<?php echo url('/v1/cate/ifications/dels'); ?>" data-id="<?php echo $vo['id']; ?>" data="-1">已启用</span>
                        <?php else: ?>
                        <span class="btn btn-danger" onclick="dels(this)" data-url="<?php echo url('/v1/cate/ifications/dels'); ?>" data-id="<?php echo $vo['id']; ?>" data="1">已禁止</span>
                        <?php endif; ?>
                    </td>
                    <td class="text-center">

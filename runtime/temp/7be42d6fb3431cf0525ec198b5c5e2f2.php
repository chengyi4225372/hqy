<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/opt/web/hqy_/public/../application/v1/view/systematic/system/addblogroll.html";i:1576137594;s:52:"/opt/web/hqy_/application/v1/view/layout/dialog.html";i:1575880777;s:50:"/opt/web/hqy_/application/v1/view/common/meta.html";i:1575011765;s:52:"/opt/web/hqy_/application/v1/view/common/script.html";i:1575011765;}*/ ?>
<!DOCTYPE html>
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="link" class="form-control form-control-sm" name="link" value=""/>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="admin_module.add_blogroll(this)" data-url="<?php echo url('/v1/systematic/system/addblogroll'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
